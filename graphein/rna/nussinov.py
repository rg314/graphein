...
# %%
# Graphein
# Author: Arian Jamasb <arian@jamasb.io>, Emmanuele Rossi, Eric Ma, Ryan Greenhalgh
# License: MIT
...
def pair_check(
    base_pair_tuple: tuple,
) -> bool:
    """Check if there is a base pair interaction.

    :param base_pair_tuple: Base pair tuple to test
    :type base_pair_tuple: tuple
    :return: True if bair pairs interact else False
    :rtype: bool
    """
    if base_pair_tuple in [("A", "U"), ("U", "A"), ("C", "G"), ("G", "C")]:
        return True
    return False
...
def optimal_pairing(
    ...
    :param i: pos i in seq
    :type i: int
    :param j: pos j in seq
    :type j: int
...
def traceback(
    ...
    :type structure: str
    :param DP: numpy matrix to cahce
    :type DP: np.ndarray
    :param sequence: RNA seq
    :type sequence: str
    """
...
def initialize(
    ...
    :param N: len of RNA seq
    :type N: int
    :return: DP matrix for algo
    :rtype: np.ndarray
    """
...
def nussinov(
    ...
    """Nussinov algo for predicting RNA ss in dot-bracket notation.

    :param sequence: RNA seq
    :type sequence: str
    :return: dot-bracket notation for RNA seq
    :rtype: str
    """
    N = len(sequence)
    DP = initialize(N)
    ...
    dot_bracked_notration = write_structure(sequence, structure)

    return dot_bracked_notration
